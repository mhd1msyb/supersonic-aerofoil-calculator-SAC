...
export var precision_step=0.01
export var starting_value=float(1.4)
export var min_slider_value=float(1.4)
export var max_slider_value=float(2)
...
func _ready():
	...
	global_var.gamma=starting_value
	label.text="Gamma : "+str(starting_value)
	hide()
...
func _input(event):
	...
	if pressed:
		...
		global_var.gamma=value
		label.text="Gamma : "+str(value)
		#print(value)
	pass
